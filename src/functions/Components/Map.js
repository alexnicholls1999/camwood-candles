export function Map() {
  const mapState = {
    ...
    mapControls: {
      zoom: 13,
      layer:
        'https://api.mapbox.com/styles/v1/alexnicholls1999/ckym1h13kngf614ruhaiqos1e/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1IjoiYWxleG5pY2hvbGxzMTk5OSIsImEiOiJjazg5NXEyc2UwMzRxM25wa3A0cWJpc3llIn0.Xjr0Tkt6MXcyqIwGUdsDIw',
      attribution:
